...
public class CreativeScreenEvents
{
    ...
    {
        final TagFilter GENERAL = new TagFilter(new ResourceLocation(com.mrcrayfish.furniture.Reference.MOD_ID, "general"), new ItemStack(ObjectUtils.firstNonNull(ModBlocks.ATMOSPHERIC_CHAIR_STRIPPED_ASPEN, ModBlocks.BIOMESOPLENTY_CHAIR_CHERRY, ModBlocks.ENVIRONMENTAL_CHAIR_WILLOW, com.mrcrayfish.furniture.core.ModBlocks.CHAIR_CRIMSON).get()));
        final TagFilter STORAGE = new TagFilter(new ResourceLocation(com.mrcrayfish.furniture.Reference.MOD_ID, "storage"), new ItemStack(ObjectUtils.firstNonNull(ModBlocks.ATMOSPHERIC_CABINET_STRIPPED_ASPEN, ModBlocks.BIOMESOPLENTY_CABINET_CHERRY, ModBlocks.ENVIRONMENTAL_CABINET_WILLOW, com.mrcrayfish.furniture.core.ModBlocks.CABINET_CRIMSON).get()));
        final TagFilter BEDROOM = new TagFilter(new ResourceLocation(com.mrcrayfish.furniture.Reference.MOD_ID, "bedroom"), new ItemStack(ObjectUtils.firstNonNull(ModBlocks.ATMOSPHERIC_DESK_STRIPPED_ASPEN, ModBlocks.BIOMESOPLENTY_DESK_CHERRY, ModBlocks.ENVIRONMENTAL_DESK_WILLOW, com.mrcrayfish.furniture.core.ModBlocks.DESK_CRIMSON).get()));
        final TagFilter OUTDOORS = new TagFilter(new ResourceLocation(com.mrcrayfish.furniture.Reference.MOD_ID, "outdoors"), new ItemStack(ObjectUtils.firstNonNull(ModBlocks.ATMOSPHERIC_MAIL_BOX_STRIPPED_ASPEN, ModBlocks.BIOMESOPLENTY_MAIL_BOX_CHERRY, ModBlocks.ENVIRONMENTAL_MAIL_BOX_WILLOW, com.mrcrayfish.furniture.core.ModBlocks.MAIL_BOX_CRIMSON).get()));
        final TagFilter KITCHEN = new TagFilter(new ResourceLocation(com.mrcrayfish.furniture.Reference.MOD_ID, "kitchen"), new ItemStack(ObjectUtils.firstNonNull(ModBlocks.ATMOSPHERIC_KITCHEN_COUNTER_STRIPPED_ASPEN, ModBlocks.BIOMESOPLENTY_KITCHEN_COUNTER_CHERRY, ModBlocks.ENVIRONMENTAL_KITCHEN_COUNTER_WILLOW, com.mrcrayfish.furniture.core.ModBlocks.KITCHEN_COUNTER_CRIMSON).get()));
